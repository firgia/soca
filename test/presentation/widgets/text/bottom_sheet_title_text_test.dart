...
void main() {
  ...
  group("Action", () {
    testWidgets("Should call [onClosePressed] when tap close button",
      ...
      await tester.runAsync(() async {
        ...
        await tester
            .tap(find.byKey(const Key("bottom_sheet_title_text_close_button")));
    ...
    testWidgets("Should hide the close button when [onClosePressed] is null",
      ...
      await tester.runAsync(() async {
        ...
        expect(
          find.byKey(const Key("bottom_sheet_title_text_close_button")),
          findsNothing,
        );
      });
    });
  ...
  group("Text", () {
    testWidgets("Should show title text", (tester) async {
      await tester.runAsync(() async {
        await tester.pumpApp(
          child: const BottomSheetTitleText(title: "Bottom sheet title"),
        );
