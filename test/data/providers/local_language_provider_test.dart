...
void main() {
  ...
  setUp(() {
    ...
    languageProvider = LocalLanguageProviderImpl();
  ...
  group(".getLanguage()", () {
    test("Should load from local json file and decode the json file", () async {
  ...
  group(".updateLastChangedOnesignal()", () {
    test("Should save data to storage", () async {
      ...
      verify(secureStorage.write(key: _lastChangedOnesignalKey, value: "test"))
          .called(1);
    });
  });
}
